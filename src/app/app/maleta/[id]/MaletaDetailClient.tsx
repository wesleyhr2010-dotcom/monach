...
export default function MaletaDetailClient({ maleta }: MaletaDetailClientProps) {
  ...
  return (
    <div className="flex flex-col min-h-full bg-app-bg relative">
      ...
      <div
        className="flex items-center pt-6 pb-4 gap-4 bg-app-bg px-5 sticky top-0 z-10"
      ...
      {/* Scrollable content */}
      <div className={`flex flex-col pb-2 ${canReturn ? "bottom-action-clearance" : "app-nav-clearance"} px-5 gap-5`}>
        ...
        {canReturn && (
          <TransitionLink
            ...
            className="block"
          >
            <div className="flex items-center justify-center rounded-[100px] py-4 px-5 gap-2 bg-app-primary shadow-[0_4px_12px_rgba(53,96,90,0.2)]">
