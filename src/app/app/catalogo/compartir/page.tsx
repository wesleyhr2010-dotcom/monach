    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center h-full bg-app-bg">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-app-primary" />
            </div>
        );
    }
    ...
    return (
        <div className="flex flex-col h-full bg-app-bg">
            ...
            <div className="sticky top-0 z-30 bg-app-bg px-4 pt-4 pb-2">
                ...
                <p className="text-xs text-app-text-secondary ml-8" style={{ fontFamily: "var(--font-raleway)" }}>
            ...
            {/* Progress */}
            {progress && (
                <div className="mx-4 mb-2 px-4 py-2 rounded-lg bg-app-primary/10 text-app-primary text-xs text-center">
                    {progress}
                </div>
            )}
            ...
            <div className="flex-1 overflow-y-auto px-4 pb-32">
                {itens.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-20 text-center">
                        <ImageOff className="w-12 h-12 text-app-muted mb-4" />
                        <p className="text-app-text-secondary text-sm" style={{ fontFamily: "var(--font-raleway)" }}>
                            ...
                            return (
                                ...
                                >
                                    {item.producto.images[0] ? (
                                        ...
                                        <div className="flex items-center justify-center w-full h-full bg-app-border">
                                            <ImageOff className="w-6 h-6 text-app-muted" />
                                        </div>
                                    )}

                                    {/* Checkmark overlay */}
                                    {isSelected && (
                                        <div className="absolute top-1.5 right-1.5 w-5 h-5 rounded-full bg-app-primary flex items-center justify-center">
            ...
            {selectedIds.length > 0 && (
                <div className="sticky bottom-[calc(59px+env(safe-area-inset-bottom)+8px)] left-0 right-0 px-4 z-40">
                    <div className="bg-app-card-bg rounded-2xl p-4 shadow-lg">
                        <div className="flex items-center justify-between mb-3">
                            ...
                            <button
                                ...
                                className="text-xs text-app-text-secondary underline"
                                style={{ fontFamily: "var(--font-raleway)" }}
                            >
                                Cancelar
                            </button>
