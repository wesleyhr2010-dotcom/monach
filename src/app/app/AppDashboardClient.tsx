...
const ReceiptIcon = () => (
  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-app-text">
...
export default function AppDashboardClient() {
  ...
  if (loading || !data) {
    return (
      <div className="absolute inset-0 flex flex-col gap-3 p-5 bg-app-bg">
        <SkeletonCard />
